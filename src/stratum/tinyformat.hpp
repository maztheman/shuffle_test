...
namespace tfm = stratum::tinyformat;
...
inline void format(FormatIterator& fmtIter, const T1& value1)
{
...
inline void format(FormatIterator& fmtIter, const T1& value1, const Args&... args)
{
    fmtIter.accept(value1);
    format(fmtIter, args...);
}
...
inline void format(detail::FormatIterator& fmtIter, TINYFORMAT_VARARGS(n))       \
{                                                                         \
    fmtIter.accept(v1);                                                   \
...
template<typename T1, typename... Args>
inline void format(std::ostream& out, const char* fmt, const T1& v1, const Args&... args)
{
...
template<typename T1, typename... Args>
inline std::string format(const char* fmt, const T1& v1, const Args&... args)
{
...
template<typename T1, typename... Args>
inline std::string format(const std::string &fmt, const T1& v1, const Args&... args)
{
    std::ostringstream oss;
...
template<typename T1, typename... Args>
inline void printf(const char* fmt, const T1& v1, const Args&... args)
{
...
#define TINYFORMAT_MAKE_FORMAT_FUNCS(n)                                   \
                                                                          \
template<TINYFORMAT_ARGTYPES(n)>                                          \
inline void format(std::ostream& out, const char* fmt, TINYFORMAT_VARARGS(n))    \
{                                                                         \
    ...
    tinyformat::detail::format(fmtIter, TINYFORMAT_PASSARGS(n));          \
                                                                          ...
                                                                          \
template<TINYFORMAT_ARGTYPES(n)>                                          \
inline std::string format(const char* fmt, TINYFORMAT_VARARGS(n))                \
{                                                                         \
    std::ostringstream oss;                                               \
    ...
    return oss.str();                                                     \
                                                                          ...
                                                                          \
template<TINYFORMAT_ARGTYPES(n)>                                          \
inline std::string format(const std::string &fmt, TINYFORMAT_VARARGS(n))         \
{                                                                         \
    std::ostringstream oss;                                               \
