#ifndef STRATUM_ZCASH_INCREMENTALMERKLETREE_HPP
#define STRATUM_ZCASH_INCREMENTALMERKLETREE_HPP
...
typedef stratum::zcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, stratum::zcash::SHA256Compress> ZCIncrementalMerkleTree;
typedef stratum::zcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, stratum::zcash::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef stratum::zcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, stratum::zcash::SHA256Compress> ZCIncrementalWitness;
typedef stratum::zcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, stratum::zcash::SHA256Compress> ZCTestingIncrementalWitness;
