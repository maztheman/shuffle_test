...
public:
    ...
    NoteEncryption(arith::uint256 hSig);
...
typedef stratum::zcash::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef stratum::zcash::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;
