...
#include <stratum/amount.hpp>
#include <stratum/script/script.hpp>
...
#include <stratum/zcash/join_split.hpp>
...
public:
    ...
    JSDescription(ZCJoinSplit& params,
            ...
            const uint256& rt,
            const boost::array<stratum::zcash::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<stratum::zcash::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
