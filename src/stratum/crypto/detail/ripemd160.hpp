#ifndef STRATUM_CRYPTO_DETAIL_RIPE_HPP
#define STRATUM_CRYPTO_DETAIL_RIPE_HPP

namespace stratum {
namespace crypto {
namespace ripemd160_detail {
...
inline void Transform(uint32_t* s, const unsigned char* chunk)
{
